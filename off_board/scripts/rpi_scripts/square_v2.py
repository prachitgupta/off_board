...
class FLIGHT_CONTROLLER:
    ...
    def __init__(self):
        ...
        self.wayplisted = rospy.Subscriber('/mavros/mission/waypoints', WaypointList, self.print_wp_list)
    ...
    def print_wp_list(self,data):
        self.wps_sent_list = data
...
if __name__ == '__main__':
    ...
    if (True):		
        ...
        mav.wpPush(wps11)
        for i in wps11:
            print(i.x_lat, i.y_long, i.z_alt)
        mav.set_mode("AUTO")
        print(mav.wps_sent_list)
        count = 0
