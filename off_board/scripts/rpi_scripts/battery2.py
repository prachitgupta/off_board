...
# gazebo local frame (x-front, y-left)
    ...
    def compute_waypoints(self):
            ...
            wp_g[4] = self.xy2latlon(wp4,origin)
            wp_g[5] = self.xy2latlon(wp5,origin)
