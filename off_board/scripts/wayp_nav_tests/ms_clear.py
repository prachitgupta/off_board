...
def compute_waypoints(mav):
		...
		wayp11 = [x_init - x_offset, y_init2 + 0,5]
		wayp12 = [x_init - x_offset - 5, y_init2 + 1.5,5]
		wayp13 = [x_init - x_offset, y_init2 + 3,5]
		wayp21 = [x_init - 0, y_init2 + 3.5,5]
		wayp22 = [x_init +5, y_init2 + 1.5,5]
		wayp23 = [x_init - 0,y_init2 + 0,5]
		...
		wps1.append(w)
		#wps2.append(w)
		w = wayp_13h.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		wps2.append(w)
		wps2.append(w)
...
if __name__ == '__main__':
	...
	if (True):		
		...
		mav.wpClear()
		mav.wpReindex(0)
		print(mav.reached_index, ' 1')
		compute_waypoints(mav)
		print(mav.reached_index, ' 2')
		mav.wpPush(wps1)
		print(mav.reached_index)
		mav.set_mode("AUTO")
		print(mav.reached_index, ' 3')
		...
		mav.wpClear()
		mav.wpReindex(0)
		print(mav.reached_index, ' 4')
		mav.set_Guided_mode()
		mav.wpPush(wps2)
		print(mav.reached_index, ' 5')
		mav.set_mode("AUTO")
		count=0
		n_prev=mav.reached_index
		print(n_prev, 'new')
