...
def compute_waypoints(mav):
		...
		wps.append(w)
		wps.append(w)
		w = wayp_12.setWaypoints(3,16,False,True,0.0,5.0,5.0,float('nan'),wp_g_12[0], wp_g_12[1], wp_g_12[2])
		wps.append(w)
		w = wayp_13.setWaypoints(3,16,False,True,0.0,5.0,5.0,float('nan'),wp_g_13[0], wp_g_13[1], wp_g_13[2])
		wps.append(w)
		w = wayp_21.setWaypoints(3,16,False,True,0.0,5.0,5.0,float('nan'),wp_g_21[0], wp_g_21[1], wp_g_21[2])
		wps.append(w)
		#w = wayp_23.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),wp_g_23[0], wp_g_23[1], wp_g_23[2])
		#wps.append(w)
		w = wayp_last.setWaypoints(3,21,False,True,0.0,0.0,0.0,float('nan'),wp_g_11[0], wp_g_11[1], wp_g_11[2])
		wps.append(w)
		print(wps)
		mav.wpPush(wps)
